...
const hardcodedLocation = { lat: 28.6208, lng: 77.0912 }; // BPIT Location
const hardcodedHospitals = [
  { name: "Saroj Super Speciality Hospital", location: { lat: 28.6988, lng: 77.1282 } },
  { name: "Jaipur Golden Hospital", location: { lat: 28.6881, lng: 77.1118 } },
  { name: "Dr. Baba Saheb Ambedkar Hospital", location: { lat: 28.6815, lng: 77.0685 } },
];
...
const NearbyHospitals = () => {
  ...
  useEffect(() => {
    ...
    L.marker([hardcodedLocation.lat, hardcodedLocation.lng], { icon: greenIcon })
      .addTo(mapInstance)
      .bindPopup("Bhagwan Parshuram Institute of Technology")
      .openPopup();
